...
const DashboardStartsGrid = () => {
    return (
        <div className='flex gap-4'>
            <BoxWrapper>
                <div className="rounded-full h-10 w-12 flex items-center justify-center bg-sky-500">
            ...
            <BoxWrapper>
                <div className="rounded-full h-10 w-12 flex items-center justify-center bg-orange-600">
